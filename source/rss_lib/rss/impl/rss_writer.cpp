	...
	const std::string sql_text =
	    "BEGIN TRANSACTION; \
			...
			CREATE TABLE IF NOT EXISTS \"feeds\" ( \
			 ...
			 \
			CREATE INDEX IF NOT EXISTS \"index_feeds_articles-feed_name\" ON \"feeds_articles\" ( \
			    \"feed_name\" ASC \
			); \
			 \
			CREATE UNIQUE INDEX IF NOT EXISTS \"index_feeds_articles-feed_name-headline_text\" ON \"feeds_articles\" ( \
			    \"feed_name\" ASC, \
			    \"headline_text\" ASC \
			); \
			 \
			CREATE UNIQUE INDEX IF NOT EXISTS \"index_feeds-feed_name-feed_url\" ON \"feeds\" ( \
			    \"feed_name\" ASC, \
			    \"feed_url\" ASC \
			); \
			 \
			CREATE UNIQUE INDEX IF NOT EXISTS \"index_feeds-feed_url\" ON \"feeds\" ( \
			    \"feed_url\" ASC \
			); \
			 \
			CREATE UNIQUE INDEX IF NOT EXISTS \"index_feeds-feed_name\" ON \"feeds\" ( \
			    \"feed_name\" ASC \
			); \
		COMMIT;";
