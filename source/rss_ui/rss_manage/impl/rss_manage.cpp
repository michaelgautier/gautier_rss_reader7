...
gautier_rss_win_rss_manage::show_dialog (GtkApplication* app, GtkWindow* parent)
{
	...
	gtk_container_add (GTK_CONTAINER (box_layout_feed_update_entry), feed_name_label);
	gtk_container_add (GTK_CONTAINER (box_layout_feed_update_entry), feed_name_entry);
	gtk_container_add (GTK_CONTAINER (box_layout_feed_update_entry), feed_url_label);
	gtk_container_add (GTK_CONTAINER (box_layout_feed_update_entry), feed_url_entry);
	gtk_container_add (GTK_CONTAINER (box_layout_feed_update_entry), feed_option_keep_all);
	gtk_container_add (GTK_CONTAINER (box_layout_feed_update_entry), feed_option_keep_last7);
	gtk_container_add (GTK_CONTAINER (box_layout_feed_update_entry), feed_option_keep_last24hr);
